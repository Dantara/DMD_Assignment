...
class FillingController:
    ...
    def generate(self, patients, h_admins, assistants, s_admins, doctors, nurses, rooms, min_salary, max_salary, salaries, inventories, payments, labs, results, checks, receipts, messages, enrolls, results_gen, test, nurse_messages):
        print('generate')
        ...
        self.model.add_n_payments(int(payments), int(min_salary), int(max_salary))
